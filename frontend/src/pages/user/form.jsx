...
const SLIDES = [
  {
    ...
    type: "form",
    label: "පෝරමය",
    title: "සිංහල අවුරුදු චාරිත්‍ර 2026",
  ...
  },
  {
    ...
    sub: "නව අවුරුද්දට පෙර චාරිත්‍ර",
    image: "greeting",
    items: [
      {
        h: "ස්නානය සහ ආගමික වතාවත්",
        t: "අප්‍රේල් මස 13 වන සඳුදා පරණ අවුරුද්ද සඳහා ස්නානය කර ආගමික වතාවත්වල යෙදී නව සඳ බැලීම අනුපිළිවෙලින් සිදු කරන්න.",
      },
    ],
  },
  {
    ...
    sub: "උදාව හා පුණ්‍ය කාලය",
    image: "stupa",
    items: [
      {
        h: "අලුත් අවුරුදු උදාව",
        t: "අප්‍රේල් මස 14 වන අඟහරුවාදා පූර්වභාග 06.32 ට සිංහල අලුත් අවුරුද්ද උදාවේ.",
      },
      {
        h: "පුණ්‍ය කාලය",
        t: "අප්‍රේල් මස 14 වන අඟහරුවාදා පූර්වභාග 05.30 සිට අපරභාග 04.32 දක්වා පුණ්‍ය කාලය බැවින් ආගමික කටයුතුවල යෙදෙන්න.",
      },
    ],
  },
  {
    ...
    items: [
      {
        h: "ආහාර පිසීම",
        t: "අප්‍රේල් මස 14 වන අඟහරුවාදා පූර්වභාග 10.43 ට දකුණු දිශාව බලා ආහාර පිසීම මැනවි.",
      },
    ],
  },
  {
    ...
    items: [
      {
        h: "ආහාර අනුභවය",
        t: "අප්‍රේල් මස 14 වන අඟහරුවාදා අපරභාග 12.05 ට දකුණු දිශාව බලා ආහාර අනුභවය මැනවි.",
      },
    ],
  },
  {
    ...
    type: "content",
    label: "05",
    title: "හිසතෙල් ගෑම සහ රැකී රක්ෂා",
    sub: "අවසාන චාරිත්‍ර",
    image: "planting",
    items: [
      {
        h: "හිසතෙල් ගෑම",
        t: "අප්‍රේල් මස 15 වන බදාදා පූර්වභාග 8.52 ට නැගෙනහිර දිශාව බලා හිස තෙල් ගෑම මැනවි.",
      },
      {
        h: "රැකී රක්ෂා සඳහා පිටත්ව යාම",
        t: "අප්‍රේල් මස 20 වන සඳුදා පූර්වභාග 06.27 ට දකුණු දිශාව බලා රැකී රක්ෂා සඳහා පිටත්ව යාම මැනවි.",
      },
    ],
  },
];
    ...
    >
      ...
      <header className="relative z-10 text-center px-4 pt-12 pb-8">
        ...
        <p className="text-sm tracking-[0.24em] uppercase text-[#9c8560]">
          April 14 · 06:32 AM · Auspicious Time
        </p>
